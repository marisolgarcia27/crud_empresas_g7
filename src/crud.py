...
@pantalla("POR FAVOR REGISTRAR EMPRESA")
def registrar_empresa():
    ruc = input("POR FAVOR INGRESE RUC : ")
    razon_social = input("POR FAVOR INGRESE RAZON SOCIAL : ")
    direccion = input("POR FAVOR INGRESE DIRECCION : ")
